    ...
    <section className="px-32 my-10">
      <div>
        ...
        <p className="mt-8 text-lg">
          ...
          pertinentes pour les professionnels de la santé. Cette section fournit
          aux membres de la communauté médicale des mises à jour régulières sur
          les événements à venir, les nouvelles collaborations, les avancées
          médicales, et d'autres sujets d'intérêt professionnel.
        </p>
      </div>
